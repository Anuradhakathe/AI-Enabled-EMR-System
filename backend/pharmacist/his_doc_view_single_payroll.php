                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 offset-md-2">
                                                <div class="mt-3 float-right">
                                                    ...
                                                    <p class="m-b-10"><strong>Employee Number. : </strong> <span class="float-right"><?php echo $row->pay_pharm_number;?></span></p>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                    ...
                                                                    $ret="SELECT  * FROM his_docs WHERE pharm_number = ?";
                                                                    $stmt= $mysqli->prepare($ret) ;
                                                                    $stmt->bind_param('s',$pharm_number);
                                                                    $stmt->execute() ;//ok
                                                                    $res=$stmt->get_result();
                                                                    $cnt=1;
                                                                    while($row=$res->fetch_object())
