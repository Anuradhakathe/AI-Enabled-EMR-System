            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-box">
                                <h4 class="header-title mb-3">Pharmacist Accounts</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-hover table-centered m-0">
                                        ...
                                        <tbody>
                                            <?php
                                            $ret = "SELECT * FROM his_pharmacist_accounts ORDER BY id DESC LIMIT 10";
                                            $stmt = $mysqli->prepare($ret);
                                            $stmt->execute();
                                            $res = $stmt->get_result();
                                            while ($row = $res->fetch_object()) {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_admin_view_single_employee.php?type=pharmacist&id=<?php echo $row->id; ?>" class="btn btn-xs btn-primary">
                    ...
                    <!-- Recently Added Front Desk Executives -->
                    <div class="row">
    <div class="col-xl-12">
        <div class="card-box">
            <h4 class="header-title mb-3">Front Desk Executives</h4>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover table-centered m-0">
                    ...
                    <tbody>
                        <?php
                        $ret = "SELECT * FROM his_admin WHERE role='frontdesk' ORDER BY ad_id DESC LIMIT 10";
                        $stmt = $mysqli->prepare($ret);
                        if (!$stmt) {
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $row->fd_number ?? '<span class="text-danger">N/A</span>'; ?></td>
                                <td>
                                    <a href="his_admin_view_single_employee.php?type=frontdesk&id=<?php echo $row->ad_id; ?>" class="btn btn-xs btn-primary">
                                        <i class="mdi mdi-eye"></i> View
                                    </a>
                                </td>
                            </tr>
